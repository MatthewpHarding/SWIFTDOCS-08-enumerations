...
👉 You can [view this document in Xcode](https://github.com/MatthewpHarding/SWIFTDOCS-8-enumerations/archive/refs/heads/main.zip) to run and edit each example.
